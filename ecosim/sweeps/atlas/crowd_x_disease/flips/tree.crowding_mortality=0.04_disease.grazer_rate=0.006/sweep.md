# Sweep `tree.crowding_mortality=0.04_disease.grazer_rate=0.006`

- params: `params.toml`
- fixed overrides: `tree.crowding_mortality=0.04`, `disease.grazer_rate=0.006`
...
|---|---|---|
| 1 | 1/3 | `fertility_band` (seeds 1, 3; worst margin -0.008) |
| 2 | 1/3 | `fertility_band` (seeds 2, 3; worst margin -0.025) |
| 3 | 1/3 | `fertility_band` (seeds 2, 3; worst margin -0.014) |
| 4 | 1/3 | `fertility_band` (seeds 2, 3; worst margin -0.042); `no_extinction` (seed 3; worst margin -1.000); `animals_10k` (seed 3; worst margin -1.000) |
| 5 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.032); `no_extinction` (seed 2; worst margin -1.000); `grazer_cycle` (seed 2; worst margin -1.000); `animals_10k` (seed 2; worst margin -1.000) |

## Extinctions by cause

- cells failing an invariant: 11 of 15
...
|---|---|---|---|
| grazers | `eaten` | 2 | rng.stream=4_s=3 @9196, rng.stream=5_s=2 @6540 |
