# Sweep `tree.crowding_mortality=0.05_disease.grazer_rate=0.006`

- params: `params.toml`
- fixed overrides: `tree.crowding_mortality=0.05`, `disease.grazer_rate=0.006`
...
|---|---|---|
| 1 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.017) |
| 2 | 1/3 | `fertility_band` (seeds 1, 3; worst margin -0.026) |
| 3 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.023) |
| 4 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.015) |
| 5 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.034); `no_extinction` (seed 2; worst margin -1.000) |

## Extinctions by cause

- cells failing an invariant: 14 of 15
- cells in which a species reaches 0 at any tick: 1 of 15
- failing cells with no extinction: 13; extinction cells passing every invariant: 0
...
|---|---|---|---|
| grazers | `eaten` | 1 | rng.stream=5_s=2 @10793 |
