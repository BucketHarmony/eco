# Sweep `grazer.energy_cost=0.16_fire.base_rate=0.004`

- params: `params.toml`
- fixed overrides: `grazer.energy_cost=0.16`, `fire.base_rate=0.004`
...
- upper edge: at 5 first fails `no_extinction` (seed 2; worst margin -1.000)
...
| 3 | 3/3 | — |
| 4 | 3/3 | — |
| 5 | 2/3 | `no_extinction` (seed 2; worst margin -1.000) |
...
|---|---|---|---|
| grazers | `eaten` | 1 | rng.stream=5_s=2 @14830 |
