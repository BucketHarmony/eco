# Sweep `climate.rain_amp=0_hunter.kill_prob=0.5`

- params: `params.toml`
- fixed overrides: `climate.rain_amp=0`, `hunter.kill_prob=0.5`
...
| 3 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.011) |
