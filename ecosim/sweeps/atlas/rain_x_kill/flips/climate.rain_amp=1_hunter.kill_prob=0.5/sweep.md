# Sweep `climate.rain_amp=1_hunter.kill_prob=0.5`

- params: `params.toml`
- fixed overrides: `climate.rain_amp=1`, `hunter.kill_prob=0.5`
...
|---|---|---|
| 1 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.053); `no_extinction` (seed 3; worst margin -1.000) |
| 2 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.052); `no_extinction` (seed 1; worst margin -1.000); `grazer_cycle` (seed 1; worst margin -1.000); `animals_10k` (seed 1; worst margin -1.000) |
| 3 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.010) |
| 4 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.067); `no_extinction` (seed 3; worst margin -1.000); `grazer_cycle` (seed 3; worst margin -1.000); `animals_10k` (seed 3; worst margin -1.000) |
| 5 | 0/3 | `fertility_band` (seeds 1, 2, 3; worst margin -0.056); `no_extinction` (seeds 2, 3; worst margin -1.000); `grazer_cycle` (seed 2; worst margin -1.000); `animals_10k` (seed 2; worst margin -1.000) |
