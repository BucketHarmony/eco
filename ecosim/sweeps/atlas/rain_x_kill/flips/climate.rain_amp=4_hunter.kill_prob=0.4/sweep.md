# Sweep `climate.rain_amp=4_hunter.kill_prob=0.4`

- params: `params.toml`
- fixed overrides: `climate.rain_amp=4`, `hunter.kill_prob=0.4`
...
- upper edge: at 4 first fails `no_extinction` (seed 3; worst margin -1.000)
  - also failing there: `animals_10k` (seed 3; worst margin -0.600)
...
| 2 | 3/3 | — |
| 3 | 3/3 | — |
| 4 | 2/3 | `no_extinction` (seed 3; worst margin -1.000); `animals_10k` (seed 3; worst margin -0.600) |
| 5 | 3/3 | — |
...
|---|---|---|---|
| hunters | `starved` | 1 | rng.stream=4_s=3 @10475 |
