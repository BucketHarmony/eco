...
- params: `params.toml`
- fixed overrides: `rain.storm_p=0.025`
- `rain.storm_mean_mm`: 40
...
|---|---|---|
| 40 | 0/3 | `no_extinction` (seeds 1, 2, 3; worst margin -1.000); `tree_growth` (seeds 1, 2, 3; worst margin -1.000); `mature_trees_10k` (seeds 1, 2, 3; worst margin -1.000) |

## Extinctions by cause

- cells failing an invariant: 3 of 3
- cells in which a species reaches 0 at any tick: 3 of 3
...
|---|---|---|---|
| trees | `unrecorded` | 3 | rain.storm_mean_mm=40_s=1 @1700, rain.storm_mean_mm=40_s=2 @1700, rain.storm_mean_mm=40_s=3 @9850 |
